...
export default function LoginPage() {
  ...
  return <main className="auth-page"><section className="auth-card"><h1>Prisijungimas</h1><p>Norėdami rezervuoti veiklą ar peržiūrėti savo rezervacijas, prisijunkite.</p><form onSubmit={submit}>
